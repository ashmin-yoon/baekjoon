...
/*
void PrintSection() {
	cout << "PrintSection()" << endl;
	for (int i = 1; i <= N; i++) {
		cout << section[i][0] << " " << section[i][1] << endl;
	}

	cout << "0 line, n+1 line " << endl;
	cout << section[0][0] << " " << section[0][1] << endl;
	cout << section[N+1][0] << " " << section[N+1][1] << endl;
}
*/
